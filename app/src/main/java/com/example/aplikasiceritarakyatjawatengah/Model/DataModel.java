package com.example.aplikasiceritarakyatjawatengah.Model;
...
public class DataModel {
    public static String[][] data = new String[][]{
            ...
            {String.valueOf(R.drawable.dewintagagini),
                    ...
                    "DEWI NAGAGINI adalah putri Hyang Anantaboga dengan Dewi Supreti dari Kahyangan Saptapratala.\n" +
                            ...
                            "\n" +
                            "\n" +
                            "    <string name=\"title_activity_jakatarub\">jakatarub</string>\n" +
                            "    <string name=\"jakatarub\">\n" +
                            "\n" +
                            ...
                            "\n" +
                            "Tak lama kemudian Mbok Milah masuk ke kamarnya. Ia bermaksud beristrihat sejenak sebelum berangkat ke sawah. Maklumlah, Mbok Milah sudah tua.ak memakan waktu lama di tengah hutan, Jaka tarub berhasil memanah seekor menjangan. Hatinya senang. Segera saja ia memanggul menjangan itu dan bermaksud segera pulang. Nasib sial rupanya datang menghampiri. Tengah asyik berjalan, tiba tiba muncul seekor macan tutul di hadapan Jaka Tarub.\n" +
                            "\n" +
            ...
            {String.valueOf(R.drawable.gunungmerapi),
                    "Gunung Merapi",
                    "dahulu kala pulau Jawa belum banyak dihuni oleh manusia. Wilayah pulau Jawa saat itu masih banyak berupa hutan belantara yang dihuni oleh binatang-binatang liar dan mahluk-mahluk gaib. Hanya beberapa bagian saja dari pulau Jawa yang dihuni oleh manusia secara berkelompok dan hidup berpindah-pindah dikarenakan kondisi alamnya yang tidak ramah. Manusia penghuni pulau Jawa yang jumlahnya masih sedikit ini tidak mengetahui bahwa kondisi pulau Jawa saat itu miring ke selatan.\n" +
                            "\n" +
                            "Pulau Jawa Miring\n" +
            ...
            },
            {
                String.valueOf(R.drawable.kawahsikidang),
                    ...
                    "Kawah Sikidang Dieng  terkenal dengan fenomena kolam kawahnya yang bisa berpindah atau melompat dalam satu kawasan yang luas. Itulah sebabnya Kawah Sikidang menjadi salah satu dari banyak kawah di kawasan wisata Dataran Tinggi Dieng yang paling diminati. Berikut Legenda Asal usul Kawah Sikidang Dieng.\n" +
                            ...
                            "\n" +
                            "Putri Shinto Dewi berpikir sejenak. Pangeran kaya raya yang sedang meminangnya ini pastilah seorang yang tampan dan berwibawa. Jika tidak, pasti pangeran tersebut tidak akan melamarnya.Pinangan Pangeran Kidang Garungan pun diterima oleh Shinto Dewi. Pangeran Garungan sangat senang ketika mendengar Iamarannya diterima. la segera mempersiapkan pesta pernikahan.\n" +
                            "\n" +
            ...
            },
            {
                    ...
                    "Kota Salatiga",
                    "Kisah Asal Mula nama Kota Salatiga, Jawa Tengah, berhubungan erat dengan Ki Ageng Pandanaran yang merupakan Bupati ke-2 Kota Semarang, Pangeran Mangkubumi dengan gelar Sunan Bayat atau Sunan Tembayat. Saat zaman Kesultanan Demak masih berkuasa penuh di Jawa Tengah, Kabupaten Semarang termasuk dalam wilayah kesultanan.\n" +
                            "\n" +
                            "Kabupaten Semarang dipimpin oleh Ki Ageng Pandanaran. Ki Ageng Pandanaran merupakan seorang pedagang yang kaya raya. Namun seiring berjalannya waktu, Ki Ageng Pandanaran malah sibuk memperkaya dirinya sendiri, sampai melupakan kesejahteraan dan keamanan rakyatnya.\n" +
                            "\n" +
                            "\n" +
                            "\n" +
                            ...
                            "\n" +
                            "“Wahai Pak Bupati terhormat, daripada menimbun harta milik rakyat, ada cara lain lebih terhormat untuk mencari harta kekayaan.” kata Sunan Kalijaga.“Memangnya siapakah kamu? Sampai berani menceramahiku?” kata Bupati Semarang.\n" +
                            "\n" +
    ...
    public static ArrayList<Model> getListData(){
        ...
        for (String[] aData : data) {
            modelData = new Model();
            modelData.setGambar(aData[0]);
            modelData.setJudul(aData[1]);
            modelData.setCerita(aData[2]);
            modelData.setPesanmoral(aData[3]);
            modelData.setSuara(aData[4]);
            list.add(modelData);
        }
        return list;
    }
